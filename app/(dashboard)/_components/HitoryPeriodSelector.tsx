...
function HitoryPeriodSelector({ period, setPeriod, timeframe, setTimeframe }: Props) {
...
export default HitoryPeriodSelector;

function YearSelector({ period, setPeriod, years }: { period: Period; setPeriod: (period: Period) => void; years: GetHistoryPeriodResponseType }) {
  return (
    <Select
